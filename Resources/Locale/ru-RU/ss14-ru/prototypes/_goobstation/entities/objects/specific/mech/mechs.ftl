...
ent-MechGygaxSyndie = Dark Gygax
    .desc = A modified Gygax used for nefarious purposes.
...
ent-MechMaulerSyndie = Mauler
    .desc = A modified Marauder once used by the Syndicate. Not as maneuverable as the Dark Gygax, but it makes up for its speed in armor and sheer firepower.
