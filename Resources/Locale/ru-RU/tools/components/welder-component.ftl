...
welder-component-on-examine-less-detailed-message = Топливо: [color={ $colorName }]{ $fuelLeft }/{ $fuelCapacity }[/color]
welder-component-incompatible-fuel = { $owner } содержит неподходящее или загрязнённое топливо!
