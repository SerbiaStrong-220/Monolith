...
frontier-lobby-exped-description = Это базовый лагерь для наёмников и им подобных. Здесь ты можешь:
...
frontier-lobby-medical-description = Гражданский медицинский диспетчерский центр ТСФ. Здесь ты можешь:
...
frontier-lobby-nfsd-description = ПОБ КВП ТСФ — это центр операций по сохранению порядка и законов ТСФ в секторе «Колосс». Здесь ты можешь:
...
frontier-lobby-pirate-description = Это главная база, где собираются силы Династии Фаэтон. Здесь ты можешь:
