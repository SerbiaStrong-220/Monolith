salvage-expedition-window-finish = Закончить экспедицию
...
salvage-weather-mod-heavy-ashfall = Сильная пепельная буря
salvage-weather-mod-medium-ashfall = Умеренная пепельная буря
salvage-weather-mod-light-ashfall = Слабая пепельная буря
