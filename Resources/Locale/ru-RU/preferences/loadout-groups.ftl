...
# Security
loadout-group-head-of-security-head = Комендант, головной убор
loadout-group-head-of-security-jumpsuit = Комендант, комбинезон
loadout-group-head-of-security-neck = Комендант, шея
