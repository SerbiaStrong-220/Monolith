...
damage-positive-armor-penetration = Пробиваемая этим броня на [color=green]{ $value }%[/color] менее эффективна.
damage-negative-armor-penetration = Пробиваемая этим броня на [color=red]{ $value }%[/color] более эффективна.
