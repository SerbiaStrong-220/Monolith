...
ghost-role-information-asakim-rules =
    ...
    1. Захватывайте точки интереса, которые могут принести пользу или помочь достичь ваших целей (исключая безопасные зоны). Для этого вы можете использовать подчиняющийся вам флот Автоматической Системы Обороны.
