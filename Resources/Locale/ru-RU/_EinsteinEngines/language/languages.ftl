...
language-SolCommon-name = Солярианский
language-SolCommon-description = Уходящий корнями в китайский, Солярианский стал официальным языком Транс Солнечной Федерации - объединяющим все колонии. На нём говорят чиновники, его преподают в школах, и используют те, кто чувствует связь с ТСФ.
...
language-NovaCygniBasic-description = Государственный язык СССП. Для большинства он звучит похоже на Солярианский, но более грубо. Его распространению способствовали поселенцы СССП и члены братвы "Бухгалтерия".
