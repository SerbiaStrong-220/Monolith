drink-component-on-use-is-empty = { CAPITALIZE($owner) } пусто!
drink-component-on-examine-is-empty = [color=gray]Пусто[/color]
drink-component-on-examine-is-opened = [color=yellow]Открыта[/color]
...
drink-component-try-use-drink-success-slurp = Ck.hg€
