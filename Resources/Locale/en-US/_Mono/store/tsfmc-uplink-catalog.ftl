...
uplink-security-t3-altair-voucher-desc = A small card that contains the data for the procurement of an Altair-class cruiser from the flagship's reserves.
