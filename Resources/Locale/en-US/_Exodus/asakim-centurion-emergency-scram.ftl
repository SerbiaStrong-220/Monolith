ent-ActionAsakimCenturionEmergencyScram = emergency displacement
    .desc = Automatically injects combat stabilizers and performs an emergency random teleport when the wearer enters critical condition.
